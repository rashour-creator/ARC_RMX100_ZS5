...
`define ALB_MSS_FAB_SLV4_PREF     dslv1_
...
`define ALB_MSS_FAB_SLV4_AW       12
`define ALB_MSS_FAB_SLV4_ENDIAN   little
`define ALB_MSS_FAB_SLV4_RESP     1
`define ALB_MSS_FAB_SLV4_ID_WIDTH 16
`define ALB_MSS_FAB_SLV4_NUM_REG  1
`define ALB_MSS_FAB_SLV4_REG_W    1
`define ALB_MSS_FAB_SLV4_REG0_BASE_ADDR  786438 // 0xc0006
`define ALB_MSS_FAB_SLV4_REG0_APER_WIDTH 12
...
`define ALB_MSS_FAB_SLV5_PREF     dslv2_
`define ALB_MSS_FAB_SLV5_CLK_NAME mss_clk
`define ALB_MSS_FAB_SLV5_CLK_EN   
`define ALB_MSS_FAB_SLV5_SUPPORT_RATIO 0
`define ALB_MSS_FAB_SLV5_PROT     axi
`define ALB_MSS_FAB_SLV5_DW       64
`define ALB_MSS_FAB_SLV5_AW       24
`define ALB_MSS_FAB_SLV5_ENDIAN   little
`define ALB_MSS_FAB_SLV5_RESP     1
`define ALB_MSS_FAB_SLV5_ID_WIDTH 16
`define ALB_MSS_FAB_SLV5_NUM_REG  1
`define ALB_MSS_FAB_SLV5_REG_W    1
`define ALB_MSS_FAB_SLV5_REG0_BASE_ADDR  790528 // 0xc1000
`define ALB_MSS_FAB_SLV5_REG0_APER_WIDTH 24
...
`define ALB_MSS_FAB_SLV6_PREF     mss_perfctrl_
`define ALB_MSS_FAB_SLV6_CLK_NAME mss_clk
`define ALB_MSS_FAB_SLV6_CLK_EN   
`define ALB_MSS_FAB_SLV6_SUPPORT_RATIO 0
`define ALB_MSS_FAB_SLV6_PROT     apb
`define ALB_MSS_FAB_SLV6_DW       32
`define ALB_MSS_FAB_SLV6_AW       13
`define ALB_MSS_FAB_SLV6_ENDIAN   little
`define ALB_MSS_FAB_SLV6_RESP     1
`define ALB_MSS_FAB_SLV6_ID_WIDTH 0
`define ALB_MSS_FAB_SLV6_NUM_REG  1
`define ALB_MSS_FAB_SLV6_REG_W    1
`define ALB_MSS_FAB_SLV6_REG0_BASE_ADDR  786434 // 0xc0002
`define ALB_MSS_FAB_SLV6_REG0_APER_WIDTH 13
`define ALB_MSS_FAB_SLV6_CONFLICT_FREE        0
`define ALB_MSS_FAB_SLV6_BUS_ECC     0
`define ALB_MSS_FAB_SLV6_BUS_ECC_PROT   32
`define ALB_MSS_FAB_SLV6_BUS_PARITY       0
`define ALB_MSS_FAB_SLV6_BUS_ECC_W          0
`define ALB_MSS_FAB_SLV6_BUS_ADDR_PTY_W      0
`define ALB_MSS_FAB_SLV7_PREF     mss_mem_
`define ALB_MSS_FAB_SLV7_CLK_NAME mss_clk
`define ALB_MSS_FAB_SLV7_CLK_EN   
`define ALB_MSS_FAB_SLV7_SUPPORT_RATIO 0
`define ALB_MSS_FAB_SLV7_PROT     ibp
`define ALB_MSS_FAB_SLV7_DW       128
`define ALB_MSS_FAB_SLV7_AW       32
`define ALB_MSS_FAB_SLV7_ENDIAN   little
`define ALB_MSS_FAB_SLV7_RESP     1
`define ALB_MSS_FAB_SLV7_ID_WIDTH 0
`define ALB_MSS_FAB_SLV7_NUM_REG  1
`define ALB_MSS_FAB_SLV7_REG_W    1
`define ALB_MSS_FAB_SLV7_REG0_BASE_ADDR  0 // 0x0
`define ALB_MSS_FAB_SLV7_REG0_APER_WIDTH 32
`define ALB_MSS_FAB_SLV7_CONFLICT_FREE        0
`define ALB_MSS_FAB_SLV7_BUS_ECC     0
`define ALB_MSS_FAB_SLV7_BUS_ECC_PROT   32
`define ALB_MSS_FAB_SLV7_BUS_PARITY       0
`define ALB_MSS_FAB_SLV7_BUS_ECC_W          0
`define ALB_MSS_FAB_SLV7_BUS_ADDR_PTY_W      0
`define ALB_MSS_FAB_UNUSED_REGION_NUM   2
`define ALB_MSS_FAB_UNUSED_REGION0_START_ADDR  262272 // 0x40080
`define ALB_MSS_FAB_UNUSED_REGION0_END_ADDR    262399 // 0x400ff
`define ALB_MSS_FAB_UNUSED_REGION1_START_ADDR  786694 // 0xc0106
`define ALB_MSS_FAB_UNUSED_REGION1_END_ADDR    790527 // 0xc0fff
