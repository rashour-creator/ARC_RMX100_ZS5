...
assign o_ibp_cmd_valid = (sdb_ibp_cmd_valid_r | i_ibp_cmd_valid)
                        ...
                        & (~wd_splt_uop_fifo_full)
                        & (~wrsp_splt_uop_fifo_full);
assign o_ibp_cmd_splt_uop = o_ibp_cmd_sel_sdb ? (sdb_ibp_cmd_valid_r & (~sdb_ibp_splt_cnt_last)) : i_ibp_need_splt;
...
endmodule // alb_mss_mem_ibp2single
