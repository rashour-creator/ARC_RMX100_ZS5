...
assign ibp_rd_chnl[RD_CHNL_ERR_RD      ]                                         = ibp_err_rd                                                                               ;
assign ibp_rd_chnl[RD_CHNL_RD_EXCL_OK  ]                                         = ibp_rd_excl_ok                                                                               ;
assign ibp_rd_chnl[RD_CHNL_RD_LAST     ]                                         = ibp_rd_last                                                                              ;
assign ibp_rd_chnl[RD_CHNL_RD_DATA_W+RD_CHNL_RD_DATA_LSB-1: RD_CHNL_RD_DATA_LSB] = ibp_rd_data                                                                              ;

assign ibp_wr_resp_accept                                                        = ibp_wrsp_chnl_accept                                                                     ;
assign ibp_wrsp_chnl_valid                                                       = ibp_wr_done | ibp_wr_excl_done | ibp_err_wr                                              ;
assign ibp_wrsp_chnl[WRSP_CHNL_WR_DONE     ]                                     = ibp_wr_done                                                                              ;
assign ibp_wrsp_chnl[WRSP_CHNL_WR_EXCL_DONE]                                     = ibp_wr_excl_done                                                                         ;
assign ibp_wrsp_chnl[WRSP_CHNL_ERR_WR      ]                                     = ibp_err_wr                                                                               ;

assign ibp_cmd_rgon  = ibp_cmd_chnl_rgon;
assign ibp_cmd_user  = ibp_cmd_chnl_user;
// leda NTL_CON16 on

endmodule // alb_mss_mem_pack2ibp
