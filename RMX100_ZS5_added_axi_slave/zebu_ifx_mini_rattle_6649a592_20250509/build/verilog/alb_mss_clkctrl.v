...
module alb_mss_clkctrl(input              ref_clk,
                       ...
                       output             mss_fab_slv6_clk_en,
                       output             mss_fab_slv7_clk_en,
                       input              rst_a,
    ...
    // generate clock enable: mss_fab_slv6_clk_en
    wire [7:0] mss_fab_slv6_clk_en_ratio;
    reg  [7:0] mss_fab_slv6_clk_en_ratio_r;

    always @ (posedge clkctrl_clk or negedge rst_b)
      begin: mss_fab_slv6_clk_en_ratio_PROC // {
         if (rst_b == 0)
            mss_fab_slv6_clk_en_ratio_r <= 8'h1;
         else if (clk_rst_cnt == 5'hF)
            mss_fab_slv6_clk_en_ratio_r <= 8'd1;
         else if (dfc_clk_stop_done)
            mss_fab_slv6_clk_en_ratio_r <= mss_fab_slv6_clk_en_ratio;
      end // }

    alb_mss_clkctrl_clken_gen u_mss_fab_slv6_clk_en_gen (
                                                      .clk_in         (clkctrl_clk),
                                                      .clk_en_in      (mss_clk_enable),
                                                      .rst_b          (rst_b),
                                                      .ratio          (mss_fab_slv6_clk_en_ratio_r),
                                                      .clk_in_align   (dfc_clk_in_align),
                                                      .clk_en_out     (mss_fab_slv6_clk_en)
                                                     );

    // generate clock enable: mss_fab_slv7_clk_en
    wire [7:0] mss_fab_slv7_clk_en_ratio;
    reg  [7:0] mss_fab_slv7_clk_en_ratio_r;

    always @ (posedge clkctrl_clk or negedge rst_b)
      begin: mss_fab_slv7_clk_en_ratio_PROC // {
         if (rst_b == 0)
            mss_fab_slv7_clk_en_ratio_r <= 8'h1;
         else if (clk_rst_cnt == 5'hF)
            mss_fab_slv7_clk_en_ratio_r <= 8'd1;
         else if (dfc_clk_stop_done)
            mss_fab_slv7_clk_en_ratio_r <= mss_fab_slv7_clk_en_ratio;
      end // }

    alb_mss_clkctrl_clken_gen u_mss_fab_slv7_clk_en_gen (
                                                      .clk_in         (clkctrl_clk),
                                                      .clk_en_in      (mss_clk_enable),
                                                      .rst_b          (rst_b),
                                                      .ratio          (mss_fab_slv7_clk_en_ratio_r),
                                                      .clk_in_align   (dfc_clk_in_align),
                                                      .clk_en_out     (mss_fab_slv7_clk_en)
                                                     );
  ...
  // and clock enable source to be valid at the same time
    ...
    /***********************************************************/
    /* mss_fab_slv6_clk_en: clock ratio run-time calculation  */
    /***********************************************************/
    wire        mss_fab_slv6_clk_en_calc_req  = 1'b0;
    wire        mss_fab_slv6_clk_en_calc_ack  = 1'b0;
    wire        mss_fab_slv6_clk_en_calc_done = 1'b1;
    wire        mss_fab_slv6_clk_en_calc_err  = 1'b0;
    assign      mss_fab_slv6_clk_en_ratio     = 8'h1;

    /***********************************************************/
    /* mss_fab_slv6_clk_en: clock ratio run-time checking  */
    /***********************************************************/
    wire        mss_fab_slv6_clk_en_chk_err = 1'b0;

    // mss_fab_slv6_clk_en_calc_status
    wire [7:0]  mss_fab_slv6_clk_en_calc_status;
    reg         mss_fab_slv6_clk_en_calc_done_r;
    reg         mss_fab_slv6_clk_en_calc_err_r;
    reg         mss_fab_slv6_clk_en_chk_err_r;

    assign      mss_fab_slv6_clk_en_calc_status = {5'b0, mss_fab_slv6_clk_en_chk_err_r,
                                                    mss_fab_slv6_clk_en_calc_err_r,
                                                    mss_fab_slv6_clk_en_calc_done_r};

    // mss_fab_slv6_clk_en_calc_done_r/_calc_err_r
    always @(posedge clkctrl_clk or negedge rst_b)
      begin: mss_fab_slv6_clk_en_calc_done_r_PROC //{
         if (!rst_b)
           begin
              mss_fab_slv6_clk_en_calc_done_r <= 1'b0;
              mss_fab_slv6_clk_en_calc_err_r  <= 1'b0;
              mss_fab_slv6_clk_en_chk_err_r   <= 1'b0;
      end
         else if (clr_calc_status)
           begin
              mss_fab_slv6_clk_en_calc_done_r <= 1'b0;
           ...
           begin
              mss_fab_slv6_clk_en_calc_done_r <= mss_fab_slv6_clk_en_calc_done;
              mss_fab_slv6_clk_en_calc_err_r  <= mss_fab_slv6_clk_en_calc_err;
              mss_fab_slv6_clk_en_chk_err_r   <= mss_fab_slv6_clk_en_chk_err;
           end
     end //} mss_fab_slv6_clk_en_calc_done_r_PROC

    /***********************************************************/
    /* mss_fab_slv7_clk_en: clock ratio run-time calculation  */
    /***********************************************************/
    wire        mss_fab_slv7_clk_en_calc_req  = 1'b0;
    wire        mss_fab_slv7_clk_en_calc_ack  = 1'b0;
    wire        mss_fab_slv7_clk_en_calc_done = 1'b1;
    wire        mss_fab_slv7_clk_en_calc_err  = 1'b0;
    assign      mss_fab_slv7_clk_en_ratio     = 8'h1;

    /***********************************************************/
    /* mss_fab_slv7_clk_en: clock ratio run-time checking  */
    /***********************************************************/
    wire        mss_fab_slv7_clk_en_chk_err = 1'b0;

    // mss_fab_slv7_clk_en_calc_status
    wire [7:0]  mss_fab_slv7_clk_en_calc_status;
    reg         mss_fab_slv7_clk_en_calc_done_r;
    reg         mss_fab_slv7_clk_en_calc_err_r;
    reg         mss_fab_slv7_clk_en_chk_err_r;

    assign      mss_fab_slv7_clk_en_calc_status = {5'b0, mss_fab_slv7_clk_en_chk_err_r,
                                                    mss_fab_slv7_clk_en_calc_err_r,
                                                    mss_fab_slv7_clk_en_calc_done_r};

    // mss_fab_slv7_clk_en_calc_done_r/_calc_err_r
    always @(posedge clkctrl_clk or negedge rst_b)
      begin: mss_fab_slv7_clk_en_calc_done_r_PROC //{
         if (!rst_b)
           begin
              mss_fab_slv7_clk_en_calc_done_r <= 1'b0;
              mss_fab_slv7_clk_en_calc_err_r  <= 1'b0;
              mss_fab_slv7_clk_en_chk_err_r   <= 1'b0;
      end
         else if (clr_calc_status)
           begin
              mss_fab_slv7_clk_en_calc_done_r <= 1'b0;
           ...
           begin
              mss_fab_slv7_clk_en_calc_done_r <= mss_fab_slv7_clk_en_calc_done;
              mss_fab_slv7_clk_en_calc_err_r  <= mss_fab_slv7_clk_en_calc_err;
              mss_fab_slv7_clk_en_chk_err_r   <= mss_fab_slv7_clk_en_chk_err;
           end
     end //} mss_fab_slv7_clk_en_calc_done_r_PROC
    ...
    assign      dfc_ratio_calc_done =
                                       ...
                                       mss_fab_slv6_clk_en_calc_done &
                                       mss_fab_slv7_clk_en_calc_done ;
    ...
    assign      dfc_ratio_calc_err =
                                       ...
                                       mss_fab_slv6_clk_en_calc_err |
                                       mss_fab_slv7_clk_en_calc_err ;
    ...
    assign      dfc_ratio_chk_err =
                                       ...
                                       mss_fab_slv6_clk_en_chk_err |
                                       mss_fab_slv7_clk_en_chk_err ;
    ...
    assign      dfc_chk_err =
                                       ...
                                       mss_fab_slv6_clk_en_chk_err_r |
                                       mss_fab_slv7_clk_en_chk_err_r ;
            ...
            begin // {
             // read
              case (mss_clkctrl_addr)
                ...
                10'd30 : i_rdata_r <= {24'h0, mss_fab_slv6_clk_en_ratio_r};     // read only
                10'd31 : i_rdata_r <= {24'h0, mss_fab_slv6_clk_en_calc_status}; // read only
                10'd32 : i_rdata_r <= {24'h0, mss_fab_slv7_clk_en_ratio_r};     // read only
                10'd33 : i_rdata_r <= {24'h0, mss_fab_slv7_clk_en_calc_status}; // read only
                10'd34 : i_rdata_r <= nmi_counter;
