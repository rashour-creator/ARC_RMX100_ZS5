...
module e2e_ecc32_1stg_qual_di_cac_wrap
...
generate
  if(SECOND_CHK==0) begin: SECOND_CHK_0
    ...
    assign sb_err = qual ? sb_err_tmp : 1'b0;
      assign db_err = (qual|diag_inj) ? (db_err_tmp ^ diag_inj) : 1'b0;
   ...
   wire [1:0]         dr_mismatch;
    ...
    assign db_err = (qual|diag_inj) ? (db_err_main || ~(^dr_mismatch ^ diag_inj)) : 1'b0;
  end
endgenerate
endmodule
