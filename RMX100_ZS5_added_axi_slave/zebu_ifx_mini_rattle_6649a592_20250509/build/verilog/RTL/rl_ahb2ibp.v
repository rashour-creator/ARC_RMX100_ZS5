...
assign biu_dmi_idle = (biu_cmd_state_r == STATE_DEFAULT) & (!ahb_hsel | (ahb_htrans == AHB_IDLE));
...
assign biu_trans_err =  (ahb_hexcl & (ahb_hburst != 3'h0) & (ahb_hburst != 3'h1))
                      | (ahb_hexcl & (ahb_hburst == 3'h1) & (ahb_htrans != AHB_NONSEQ))
					  | (ahb_hexcl & (ahb_htrans == AHB_BUSY))
					  ;
...
if(ARB_IN_BIU == 1) begin: arb_in_biu_eq_1
...
else begin: arb_in_biu_eq_0 //}{

assign ibp_cmd_prio = ahb_prio;
