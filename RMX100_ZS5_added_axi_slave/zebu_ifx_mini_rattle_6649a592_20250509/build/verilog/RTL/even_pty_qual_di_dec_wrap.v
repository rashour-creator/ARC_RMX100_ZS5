...
module even_pty_qual_di_dec_wrap
  #(
...
generate
  if(SECOND_CHK==0) begin: SECOND_CHK_0
    ...
    assign parity_err = (qual|diag_inj) ? (parity_err_tmp^diag_inj)  : 1'b0;
    ...
    assign parity_err = (qual|diag_inj) ? (parity_err_main || ~(^mismatch^diag_inj)) : 1'b0;
