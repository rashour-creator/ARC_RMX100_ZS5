...
ifeq ($(CUSTOM_ZEMI3_DIR), 1)
	...
	make -C ./"xtor_xtor_amba_slave_axi3_svs/zxtor/xtor_amba_slave_axi3_svs" comp
	cp ./"xtor_xtor_amba_slave_axi3_svs/zxtor/xtor_amba_slave_axi3_svs"/*.h $(OBJ_DIR)
	cp ./"xtor_xtor_amba_slave_axi3_svs/zxtor/xtor_amba_slave_axi3_svs"/*.zsym $(OBJ_DIR)
	...
	make -C ./"xtor_xtor_amba_slave_axi3_svs/zxtor/xtor_amba_slave_axi3_svs" comp
	cp ./"xtor_xtor_amba_slave_axi3_svs/zxtor/xtor_amba_slave_axi3_svs"/*.h .
	cp ./"xtor_xtor_amba_slave_axi3_svs/zxtor/xtor_amba_slave_axi3_svs"/*.so .
	cp ./"xtor_xtor_amba_slave_axi3_svs/zxtor/xtor_amba_slave_axi3_svs"/*.zsym .
	make -C ./"xtor_xtor_t32Jtag_svs/zxtor/xtor_t32Jtag_svs" comp
...
install:
	...
	make -C ./"xtor_xtor_amba_slave_axi3_svs/zxtor/xtor_amba_slave_axi3_svs" install
...
clean:
	...
	make -C ./"xtor_xtor_amba_slave_axi3_svs/zxtor/xtor_amba_slave_axi3_svs" clean
