exec > /remote/sdgedt/tools/reem/ZebuS5_newslave/zebu_ifx_mini_rattle_6649a592_20250509/build/zcui.work/./zCui/log/backend_default_zCoreBuildTiming_Part_0_U0_M0_F0.log
exec 2>&1
...
export ZCUI_MESSAGES_CONFIG='task=backend_default_zCoreBuildTiming_Part_0_U0_M0_F0|pid=1228136|index=0|tcphost=us01odcvde23280.internal.synopsys.com|tcpport=5202|retry=10|delay=500|blocking=1|nmap=0'
