...
if ( `pwd` != "/remote/sdgedt/tools/reem/ZebuS5_newslave/zebu_ifx_mini_rattle_6649a592_20250509/build" ) then
  echo "Warning: Working directory is changed."
  echo "Executing the postelab script in the same working directory is recommended."
  echo "    Previous path: /remote/sdgedt/tools/reem/ZebuS5_newslave/zebu_ifx_mini_rattle_6649a592_20250509/build"
  echo "    Current path: `pwd`"
  echo ""
endif

cd /remote/sdgedt/tools/reem/ZebuS5_newslave/zebu_ifx_mini_rattle_6649a592_20250509/build
/bin/sh -f /remote/sdgedt/tools/reem/ZebuS5_newslave/zebu_ifx_mini_rattle_6649a592_20250509/build/zcui.work/vcs_splitter/simv.daidir/.elabcomCmd

set ELABCOM_STATUS=0;
set CONTENT=`cat /remote/sdgedt/tools/reem/ZebuS5_newslave/zebu_ifx_mini_rattle_6649a592_20250509/build/zcui.work/vcs_splitter/simv.daidir/.elabcomReport`;
...
set ELABCOM_LOG=/remote/sdgedt/tools/reem/ZebuS5_newslave/zebu_ifx_mini_rattle_6649a592_20250509/build/zcui.work/vcs_splitter/simv.daidir/elabcomLog/compiler.log
...
set ELABCOM_CRASH_TAG=/remote/sdgedt/tools/reem/ZebuS5_newslave/zebu_ifx_mini_rattle_6649a592_20250509/build/zcui.work/vcs_splitter/simv.daidir/.elabcom_crash_tag
