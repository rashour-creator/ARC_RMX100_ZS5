...
#include <unistd.h>
#include "TOP_RtlClockToleranceRT.hh"

ZEBU_RtlClockToleranceRT_Top RtlClockToleranceRT;

ZEBU::Memory **RtlClockToleranceRT_memtbl;
...
int ZEBU_RtlClockToleranceRT_Init(ZEBU::Board *zebu) {
    ...
    RtlClockToleranceRT_memtbl = new ZEBU::Memory*[1];
    RtlClockToleranceRT_memtbl[0] = NULL;
    return 0;
}
