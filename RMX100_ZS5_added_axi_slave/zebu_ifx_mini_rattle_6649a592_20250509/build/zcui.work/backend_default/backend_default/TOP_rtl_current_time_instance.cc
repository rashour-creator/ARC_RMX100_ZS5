...
#include <unistd.h>
#include "TOP_rtl_current_time_instance.hh"

ZEBU_rtl_current_time_instance_Top rtl_current_time_instance;

ZEBU::Memory **rtl_current_time_instance_memtbl;
...
int ZEBU_rtl_current_time_instance_Init(ZEBU::Board *zebu) {
    ...
    rtl_current_time_instance_memtbl = new ZEBU::Memory*[1];
    rtl_current_time_instance_memtbl[0] = NULL;
    return 0;
}
