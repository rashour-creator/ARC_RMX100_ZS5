...
set zpar_fwc_ip_cmd {fwc  zcg_compositeClock -optimize area -version gen2 -sampling_frequency 50000 -unit 0 -module 0 -fpga F0  -fwfile zs5_hw_zPar.edf.gz -forceTopName zebu_top -originalDesignPath U0_M0_F0.U0_M0_F0_core -sabrefwfile undefined_fx_pas_lib.edf.gz }
...
set complexity_predictor_bin 0
