...
#include <unistd.h>
#include "TOP_zebu_rtl_clock_debug.hh"

ZEBU_zebu_rtl_clock_debug_Top zebu_rtl_clock_debug;

ZEBU::Memory **zebu_rtl_clock_debug_memtbl;
...
int ZEBU_zebu_rtl_clock_debug_Init(ZEBU::Board *zebu) {
    ...
    zebu_rtl_clock_debug_memtbl = new ZEBU::Memory*[1];
    zebu_rtl_clock_debug_memtbl[0] = NULL;
    return 0;
}
