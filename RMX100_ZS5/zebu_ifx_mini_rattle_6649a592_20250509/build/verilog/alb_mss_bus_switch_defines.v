...
`define BUS_SWITCH_SLV_NUM         6
`define BUS_SWITCH_SRAM_MEM_IDX    5
...
`define BUS_SWITCH_SLV4_PFX                  mss_perfctrl_bs_
...
`define BUS_SWITCH_SLV4_BASE_ADDR             786434 // 0xc0002
`define BUS_SWITCH_SLV4_UP_ADDR               786435 // 0xc0003
`define BUS_SWITCH_SLV4_REG0_BASE_ADDR  786434 // 0xc0002
`define BUS_SWITCH_SLV4_REG0_APER_WIDTH 13
`define BUS_SWITCH_SLV5_PFX                  mss_mem_bs_
`define BUS_SWITCH_SLV5_AW                   42
`define BUS_SWITCH_SLV5_DW                   128
`define BUS_SWITCH_SLV5_CONFLICT_FREE        0
`define BUS_SWITCH_SLV5_REGION_WIDTH         1
`define BUS_SWITCH_SLV5_REGION_NUM           1
`define BUS_SWITCH_SLV5_BASE_ADDR             0 // 0x0
`define BUS_SWITCH_SLV5_UP_ADDR               1048575 // 0xfffff
`define BUS_SWITCH_SLV5_REG0_BASE_ADDR  0 // 0x0
`define BUS_SWITCH_SLV5_REG0_APER_WIDTH 32
...
`define MSS_BUS_SWITCH_DW32_SLV_RGON_W                  7
...
`define MSS_BUS_SWITCH_DW32_SLV_O_BUS_NUM               7
...
`define MSS_BUS_SWITCH_DW64_SLV_RGON_W                  7
...
`define MSS_BUS_SWITCH_DW64_SLV_O_BUS_NUM               7
...
`define MSS_BUS_SWITCH_DW128_SLV_RGON_W                  7
...
`define MSS_BUS_SWITCH_DW128_SLV_O_BUS_NUM               7
...
`define MSS_BUS_SWITCH_DW256_SLV_RGON_W                  7
...
`define MSS_BUS_SWITCH_DW256_SLV_O_BUS_NUM               7
...
`define MSS_BUS_SWITCH_DW512_SLV_RGON_W                  7
...
`define MSS_BUS_SWITCH_DW512_SLV_O_BUS_NUM               7
...
`define MSS_BUS_SWITCH_IBP_DW32_4_MST_O_BUS_INST_PFX    mss_perfctrl_bs_
`define MSS_BUS_SWITCH_IBP_DW32_5_MST_O_BUS_INST_PFX    mss_mem_bs_
...
`define MSS_BUS_SWITCH_IBP_DW64_4_MST_O_BUS_INST_PFX    mss_perfctrl_bs_
`define MSS_BUS_SWITCH_IBP_DW64_5_MST_O_BUS_INST_PFX    mss_mem_bs_
...
`define MSS_BUS_SWITCH_IBP_DW128_4_MST_O_BUS_INST_PFX    mss_perfctrl_bs_
`define MSS_BUS_SWITCH_IBP_DW128_5_MST_O_BUS_INST_PFX    mss_mem_bs_
...
`define MSS_BUS_SWITCH_IBP_DW256_4_MST_O_BUS_INST_PFX    mss_perfctrl_bs_
`define MSS_BUS_SWITCH_IBP_DW256_5_MST_O_BUS_INST_PFX    mss_mem_bs_
...
`define MSS_BUS_SWITCH_IBP_DW512_4_MST_O_BUS_INST_PFX    mss_perfctrl_bs_
`define MSS_BUS_SWITCH_IBP_DW512_5_MST_O_BUS_INST_PFX    mss_mem_bs_
