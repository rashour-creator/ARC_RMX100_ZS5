...
// Description:
//
//  This file implements a behavioural model of an ICCM memory
//
//
...
initial 
begin : init
  localparam ICCM0_SIZE = 1<<par_addr_msb;
  for (i=0; i < ICCM0_SIZE/16; i=i+1) begin
    // u_ram_core_inst.ram_core_0[i] = ({$random} % `ICCM0_BANK_WIDTH);
