...
function automatic [6:0] e2e_ecc32_1stg_enc;
    input [31:0] data_in;
...
begin
    ...
    e2e_ecc32_1stg_enc = ecc;
end
endfunction


// This function returns the {overall_parity, syndrome}
function automatic [6:0] e2e_ecc32_1stg_dec_a;
    input [31:0] data_in;
    input [6 :0] ecc_in;
...
// SJ: Intended behavior - EDC/PTY are checked at the top 
    ...
    e2e_ecc32_1stg_dec_a = {overall_parity, syndrome};
...
function automatic [2:0] e2e_ecc32_1stg_dec_b;
    input enable;
    input [5:0] syndrome;
...
// Checks if the syndrome is unused syndrome
    ...
    e2e_ecc32_1stg_dec_b = {unknown_err, double_err, single_err};
end
endfunction


// This function returns the corrected data;
function automatic [31:0] e2e_ecc32_1stg_dec_c;
    input overall_parity_and_enable;
    input [5:0] syndrome;
    input [31:0] data_in;
    reg [31:0] data_out;
begin
    ...
    e2e_ecc32_1stg_dec_c = data_out;
end
endfunction


// This function returns the corrected ecc code;
function automatic [6 :0] e2e_ecc32_1stg_dec_d;
    input overall_parity_and_enable;
    input [5:0] syndrome;
    input [6 :0] ecc_in;
    reg [6 :0] ecc_out;
