...
`define    RL_DMP_DCCM_ECC_TOTAL_WIDTH    40
`define    RL_DMP_DCCM_ECC_TOTAL_RANGE    39:0
`define    RL_DMP_DCCM_ECC_CHKBIT_WIDTH   8
`define    RL_DMP_DCCM_ECC_CHKBIT_RANGE   39:`DATA_BITS

// This function returns the check bits
function automatic [7:0] rl_dmp_dccm_ecc_enc;
    input [31:0] data_in;
    input [16:0] address;
...
begin
    ...
    edc_tmp[0] = ^(word_in & 49'b1101010101010101010101010101010101010110101011011);
    edc_tmp[1] = ^(word_in & 49'b0110011001100110011001101001100110011011001101101);
    edc_tmp[2] = ^(word_in & 49'b0111100001111000011110001110000111100011110001110);
    edc_tmp[3] = ^(word_in & 49'b0000000001111111100000001111111000000011111110000);
    edc_tmp[4] = ^(word_in & 49'b0111111110000000000000001111111111111100000000000);
    edc_tmp[5] = ^(word_in & 49'b0111111111111111111111110000000000000000000000000);
    edc_tmp[6] = ^(word_in & 49'b1000000000000000000000000000000000000000000000000);
    ...
    rl_dmp_dccm_ecc_enc = ecc;
end
endfunction


// This function returns the {overall_parity, syndrome}
function automatic [7:0] rl_dmp_dccm_ecc_dec_a;
    input [31:0] data_in;
    input [16:0] address;
    input [7 :0] ecc_in;
...
begin
    ...
    calc_edc[0] = ^(word_in & 49'b1101010101010101010101010101010101010110101011011);
    calc_edc[1] = ^(word_in & 49'b0110011001100110011001101001100110011011001101101);
    calc_edc[2] = ^(word_in & 49'b0111100001111000011110001110000111100011110001110);
    calc_edc[3] = ^(word_in & 49'b0000000001111111100000001111111000000011111110000);
    calc_edc[4] = ^(word_in & 49'b0111111110000000000000001111111111111100000000000);
    calc_edc[5] = ^(word_in & 49'b0111111111111111111111110000000000000000000000000);
    calc_edc[6] = ^(word_in & 49'b1000000000000000000000000000000000000000000000000);
    ...
    rl_dmp_dccm_ecc_dec_a = {overall_parity, syndrome};
end
endfunction


// This function returns the {unknown_err, double_err, single_err, addr_err};
function automatic [3:0] rl_dmp_dccm_ecc_dec_b;
    input enable;
    input [6:0] syndrome;
...
begin
    ...
    (syndrome == 18) | (syndrome == 19) | (syndrome == 20) | (syndrome == 21) | (syndrome == 22);

// Checks if the syndrome is unused syndrome
    is_unused_syndrome = (syndrome == 31) | (syndrome == 56) | (syndrome == 57) | (syndrome == 58) | (syndrome == 59) | (syndrome == 60) | 
    ...
    rl_dmp_dccm_ecc_dec_b = {unknown_err, double_err, single_err, addr_err};
end
endfunction


// This function returns the corrected data;
function automatic [31:0] rl_dmp_dccm_ecc_dec_c;
    input overall_parity_and_enable;
    input [6:0] syndrome;
    input [31:0] data_in;
    reg [31:0] data_out;
begin
    ...
    if (overall_parity_and_enable) begin
        case(syndrome)
        (23) :        data_out[0] = ~data_in[0];
        (24) :        data_out[1] = ~data_in[1];
        (25) :        data_out[2] = ~data_in[2];
        (26) :        data_out[3] = ~data_in[3];
        (27) :        data_out[4] = ~data_in[4];
        (28) :        data_out[5] = ~data_in[5];
        (29) :        data_out[6] = ~data_in[6];
        (30) :        data_out[7] = ~data_in[7];
        (33) :        data_out[8] = ~data_in[8];
        (34) :        data_out[9] = ~data_in[9];
        (35) :        data_out[10] = ~data_in[10];
        (36) :        data_out[11] = ~data_in[11];
        (37) :        data_out[12] = ~data_in[12];
        (38) :        data_out[13] = ~data_in[13];
        (39) :        data_out[14] = ~data_in[14];
        (40) :        data_out[15] = ~data_in[15];
        (41) :        data_out[16] = ~data_in[16];
        (42) :        data_out[17] = ~data_in[17];
        (43) :        data_out[18] = ~data_in[18];
        (44) :        data_out[19] = ~data_in[19];
        (45) :        data_out[20] = ~data_in[20];
        (46) :        data_out[21] = ~data_in[21];
        (47) :        data_out[22] = ~data_in[22];
        (48) :        data_out[23] = ~data_in[23];
        (49) :        data_out[24] = ~data_in[24];
        (50) :        data_out[25] = ~data_in[25];
        (51) :        data_out[26] = ~data_in[26];
        (52) :        data_out[27] = ~data_in[27];
        (53) :        data_out[28] = ~data_in[28];
        (54) :        data_out[29] = ~data_in[29];
        (55) :        data_out[30] = ~data_in[30];
        (65) :        data_out[31] = ~data_in[31];
        endcase
    end
    rl_dmp_dccm_ecc_dec_c = data_out;
end
endfunction


// This function returns the corrected ecc code;
function automatic [7 :0] rl_dmp_dccm_ecc_dec_d;
    input overall_parity_and_enable;
    input [6:0] syndrome;
    input [7 :0] ecc_in;
    reg [7 :0] ecc_out;
