...
generate
    ...
    if ((F_SYNC_TYPE & 7) == 2) begin : GEN_FST2
      ...
      DWbb_bcm99 #(.ACCURATE_MISSAMPLING(TECH_MAPPING_LAM)) U_SAMPLE_META_2[WIDTH-1:0] (
        .clk_d(clk_d),
        .rst_d_n(rst_d_n),
        .data_s(next_sample_meta),
// spyglass disable_block W402b
// SMD: is gated or internally generated (in module cln_aon)
...
// spyglass enable_block W402b
    ...
    if ((F_SYNC_TYPE & 7) == 3) begin : GEN_FST3
      ...
      DWbb_bcm99_3 #(.ACCURATE_MISSAMPLING(0)) U_SAMPLE_META_3[WIDTH-1:0] (
        .clk_d(clk_d),
        .rst_d_n(rst_d_n),
        .data_s(next_sample_meta),
        .data_d(sample_syncl)
    ...
    if ((F_SYNC_TYPE & 7) == 4) begin : GEN_FST4
      ...
      DWbb_bcm99_4 #(.ACCURATE_MISSAMPLING(0)) U_SAMPLE_META_4[WIDTH-1:0] (
        .clk_d(clk_d),
        .rst_d_n(rst_d_n),
        .data_s(next_sample_meta),
        .data_d(sample_syncl)
...
`endif
  ...
  generate
    ...
    if (SVA_TYPE_BIT1BIT0 == 1) begin : GEN_SVATP_EQ_1
      ...
      DWbb_sva01 #(WIDTH, (F_SYNC_TYPE & 7), VERIF_EN) P_SYNC_HS (.*);
    end
    ...
    `endif
      ...
      DWbb_sva05 #(WIDTH, (F_SYNC_TYPE & 7)) P_SYNC_GC (.*);
    end

    if (SVA_TYPE_BIT2 == 0) begin : GEN_SVATP_BIT2_EQ_0
      DWbb_sva08 #(WIDTH) P_SYNC_EQ_RST (.*);
    end
  endgenerate
  `else
    `ifdef DW_MODEL_MISSAMPLES
  DWbb_bvm02 U_CLK_DET (
    .clk         (clk_d        ),
    .rst_n       (rst_d_n      ),
    .clk_stopped (clk_d_stopped),
    .clk_period  (clk_d_period )
