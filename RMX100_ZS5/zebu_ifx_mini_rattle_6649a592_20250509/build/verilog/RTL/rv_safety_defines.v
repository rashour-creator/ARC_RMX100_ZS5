...
`define CPU_PREFIX  ""
`define ERROR_UNLOCKED 2'b01
`define ERROR_LOCKED   2'b10
`define SAFETY_ERROR     2'b10
`define SAFETY_OK        2'b01
`define ECC_OPTION_ADDR_FAKE 0
`define SAFETY_LOW_N     2'b00
`define SAFETY_HIGH_N    2'b11
`define SAFETY_LOW       2'b01
`define SAFETY_HIGH      2'b10
`define IRQ_DUAL_RAIL 0
`define HAS_WDT 1
`define WATCHDOG_CLK 1
`define WATCHDOG_NUM 1
    `define SFTY_SYNC_LEGACY_IMPL 0  
    `define SFTY_SYNC_CDC_FF_LEVELS  2
    `define SFTY_SYNC_TMR_CDC     0
    `define SFTY_DW_CDC_VERIF_EN  0
    `define SFTY_DW_CDC_SVA_TYPE  0
