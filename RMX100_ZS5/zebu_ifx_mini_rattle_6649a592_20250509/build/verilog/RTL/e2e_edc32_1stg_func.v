...
function automatic [5:0] e2e_edc32_1stg_enc;
    input [31:0] data_in;
...
begin
    ...
    e2e_edc32_1stg_enc = edc;
end
endfunction


// This function returns the syndrome
function automatic [5:0] e2e_edc32_1stg_dec_a;
    input [31:0] data_in;
    input [5:0] edc_in;
...
function automatic [0:0] e2e_edc32_1stg_dec_b;
    input enable;
    input [5:0] syndrome;
    reg err;
...
begin
    ...
    e2e_edc32_1stg_dec_b = err;
end
endfunction


// This function returns the corrected data;
function automatic [31:0] e2e_edc32_1stg_dec_c;
...
begin
    ...
    e2e_edc32_1stg_dec_c = data_out;
end
endfunction


// This function returns the corrected ecc code;
function automatic [6 :0] e2e_edc32_1stg_dec_d;
    input overall_parity_and_enable;
    input [5:0] syndrome;
    input [6 :0] ecc_in;
    reg [6 :0] ecc_out;
