...
`define    ICCM_ECC_TOTAL_WIDTH    40
`define    ICCM_ECC_TOTAL_RANGE    39:0
`define    ICCM_ECC_CHKBIT_WIDTH   8
`define    ICCM_ECC_CHKBIT_RANGE   39:`DATA_BITS

// This function returns the check bits
function automatic [7:0] iccm_ecc_enc;
    input [31:0] data_in;
    input [16:0] address;
...
function automatic [7:0] iccm_ecc_dec_a;
    input [31:0] data_in;
    input [16:0] address;
    input [7 :0] ecc_in;
...
begin
    ...
    iccm_ecc_dec_a = {overall_parity, syndrome};
end
endfunction


// This function returns the {unknown_err, double_err, single_err, addr_err};
function automatic [3:0] iccm_ecc_dec_b;
    input enable;
    input [6:0] syndrome;
...
// Checks if the syndrome is unused syndrome
    ...
    iccm_ecc_dec_b = {unknown_err, double_err, single_err, addr_err};
end
endfunction


// This function returns the corrected data;
function automatic [31:0] iccm_ecc_dec_c;
    input overall_parity_and_enable;
    input [6:0] syndrome;
    input [31:0] data_in;
    reg [31:0] data_out;
begin
    ...
    iccm_ecc_dec_c = data_out;
end
endfunction


// This function returns the corrected ecc code;
function automatic [7 :0] iccm_ecc_dec_d;
    input overall_parity_and_enable;
    input [6:0] syndrome;
    input [7 :0] ecc_in;
    reg [7 :0] ecc_out;
