...
// the following wire definition is a VTOC code generation bug work around
wire [DATA_W-1:0] ibp_rd_chnl_valid_mask = {RD_CHNL_RD_DATA_W{ibp_rd_chnl_valid}};
...
assign ibp_cmd_chnl[CMD_CHNL_READ      ]                                                        = ibp_cmd_read;
assign ibp_cmd_chnl[CMD_CHNL_WRAP      ]                                                        = ibp_cmd_wrap;
assign ibp_cmd_chnl[CMD_CHNL_ADDR_W      +CMD_CHNL_ADDR_LSB      -1 : CMD_CHNL_ADDR_LSB      ]  = ibp_cmd_addr;
assign ibp_cmd_chnl[CMD_CHNL_DATA_SIZE_W +CMD_CHNL_DATA_SIZE_LSB -1 : CMD_CHNL_DATA_SIZE_LSB ]  = ibp_cmd_data_size;
assign ibp_cmd_chnl[CMD_CHNL_BURST_SIZE_W+CMD_CHNL_BURST_SIZE_LSB-1 : CMD_CHNL_BURST_SIZE_LSB]  = ibp_cmd_burst_size;
assign ibp_cmd_chnl[CMD_CHNL_PROT_W+CMD_CHNL_PROT_LSB-1 : CMD_CHNL_PROT_LSB]                    = ibp_cmd_prot;
assign ibp_cmd_chnl[CMD_CHNL_CACHE_W+CMD_CHNL_CACHE_LSB-1 : CMD_CHNL_CACHE_LSB]                 = ibp_cmd_cache;
assign ibp_cmd_chnl[CMD_CHNL_LOCK      ]                                                        = ibp_cmd_lock;
assign ibp_cmd_chnl[CMD_CHNL_EXCL      ]                                                        = ibp_cmd_excl;

assign ibp_wd_chnl_valid                                                                        = ibp_wr_valid;
assign ibp_wr_accept                                                                            = ibp_wd_chnl_accept;
assign ibp_wd_chnl[WD_CHNL_DATA_W+WD_CHNL_DATA_LSB-1 : WD_CHNL_DATA_LSB]                        = ibp_wr_data;
assign ibp_wd_chnl[WD_CHNL_MASK_W+WD_CHNL_MASK_LSB-1 : WD_CHNL_MASK_LSB]                        = ibp_wr_mask;
assign ibp_wd_chnl[WD_CHNL_LAST       ]                                                         = ibp_wr_last;

assign ibp_rd_chnl_accept                                                                       = ibp_rd_accept;
assign ibp_rd_valid                                                                             = ibp_rd_chnl_valid & (~ibp_rd_chnl[RD_CHNL_ERR_RD      ]);
assign ibp_rd_excl_ok                                                                           = ibp_rd_chnl_valid & ibp_rd_chnl[RD_CHNL_RD_EXCL_OK    ];
assign ibp_err_rd                                                                               = ibp_rd_chnl_valid & ibp_rd_chnl[RD_CHNL_ERR_RD      ];
assign ibp_rd_last                                                                              = ibp_rd_chnl_valid & ibp_rd_chnl[RD_CHNL_RD_LAST     ];
assign ibp_rd_data                                                                              = ibp_rd_chnl_valid_mask & ibp_rd_chnl[RD_CHNL_RD_DATA_W+RD_CHNL_RD_DATA_LSB-1:RD_CHNL_RD_DATA_LSB];

assign ibp_wrsp_chnl_accept                                                                     = ibp_wr_resp_accept;
assign ibp_wr_done                                                                              = ibp_wrsp_chnl_valid & ibp_wrsp_chnl[WRSP_CHNL_WR_DONE     ];
assign ibp_wr_excl_done                                                                         = ibp_wrsp_chnl_valid & ibp_wrsp_chnl[WRSP_CHNL_WR_EXCL_DONE];
assign ibp_err_wr                                                                               = ibp_wrsp_chnl_valid & ibp_wrsp_chnl[WRSP_CHNL_ERR_WR      ];
...
endmodule // alb_mss_mem_ibp2pack
